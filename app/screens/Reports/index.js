...
function TabPanel(props) {
    ...
    return (React.createElement(Typography_1.default, __assign({ component: "div", role: "tabpanel", hidden: value !== index, id: "vertical-tabpanel-" + index, "aria-labelledby": "vertical-tab-" + index }, other), value === index && React.createElement(Box_1.default, { p: 3 }, children)));
}
...
var index = function (props) {
    ...
    return (React.createElement("div", { className: classes.root },
        React.createElement(Tabs_1.default, { orientation: "vertical", variant: "scrollable", value: value, onChange: handleChange, "aria-label": "Vertical tabs example", className: classes.tabs },
            ...
            React.createElement(Tab_1.default, __assign({ label: "Item Sales Report" }, a11yProps(1), { style: {
            ...
            React.createElement(Tab_1.default, __assign({ label: "Inventory Report" }, a11yProps(2), { style: {
            ...
            React.createElement(Tab_1.default, __assign({ label: "Cost Report" }, a11yProps(3), { style: {
            ...
            React.createElement(Tab_1.default, __assign({ label: "Inventory Purchase Report" }, a11yProps(4), { style: {
            ...
            React.createElement(Tab_1.default, __assign({ label: "RB Report" }, a11yProps(5), { style: {
        ...
        React.createElement(TabPanel, { value: value, index: 3 },
            React.createElement(Cost_1.default, null)),
