...
var WorkPeriod = function (state, action) {
    ...
    switch (action.type) {
        case "STARTWORKPERIOD":
            state = __assign({}, state, { isStarted: true, dateStarted: action.dateStarted, time: "", date: action.date, dateEnded: action.dateEnded, note: action.note, ticketsId: action.ticketsId, userId: action.userId, department: action.department, fileName: action.fileName, workedFor: action.workedFor, year: action.year, month: action.month, week: action.week, day: action.day });
            break;
        case "UPDATEWORKPERIOD":
            ...
            break;
        case "ENDWORKPERIOD":
            state = __assign({}, state, { isStarted: false, dateStarted: "", time: "", date: "", dateEnded: "", note: "", ticketsId: [], userId: "", department: "", fileName: "", workedFor: "", year: "", month: "", week: "", day: "" });
            break;
        default:
            return state;
    }
